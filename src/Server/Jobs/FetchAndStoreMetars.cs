...
public class FetchAndStoreMetars : IInvocable
{
    ...
    public FetchAndStoreMetars(ILogger<FetchAndStoreMetars> logger, IDbContextFactory<ZoaIdsContext> contextFactory, HttpClient httpClient)
    {
        _logger = logger;
    ...
    {   
        ...
        // Fetch and parse XML
        using var responseStream = await _httpClient.GetStreamAsync(Constants.Urls.MetarsXml);
