...
public class AircraftTypeInfo
{
	...
	public AircraftTypeInfo() { }

	public AircraftTypeInfo(string icaoId, string manufacturer, string model, string description, string engineType, string engineCount, string faaWakeTurbulenceCategory)
	{
		IcaoId = icaoId;
