...
namespace ZoaIdsBackend.Modules.VnasData.Models;
...
public class VideoMap
{
    ...
    [JsonPropertyName("lineDefaults")]
    public LineDefaults LineDefaults { get; set; }

    [JsonPropertyName("textDefaults")]
    public TextDefaults TextDefaults { get; set; }

    [JsonPropertyName("symbolDefaults")]
    public SymbolDefaults SymbolDefaults { get; set; }

    [JsonPropertyName("shortName")]
    public string ShortName { get; set; }

    [JsonPropertyName("starsMapGroup")]
    public string StarsMapGroup { get; set; }
}
